  ...
  (n.m = _),
    ...
    (n.O = (a, r, o, t) => {
      if (!r) {
        ...
        for (f = 0; f < e.length; f++) {
          for (var [r, o, t] = e[f], s = !0, u = 0; u < r.length; u++)
            (!1 & t || c >= t) && Object.keys(n.O).every((h) => n.O[h](r[u]))
              ? r.splice(u--, 1)
              : ((s = !1), t < c && (c = t));
          if (s) {
            e.splice(f--, 1);
    ...
    (() => {
      ...
      var a = (o, t) => {
          ...
          for (o && o(t); v < f.length; v++)
            n.o(e, (l = f[v])) && e[l] && e[l][0](), (e[l] = 0);
          return n.O(d);
        },
        r = (self.webpackChunkprojeto_buzzfeed =
